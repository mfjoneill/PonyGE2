...
class Individual(object):
    ...
    def evaluate(self, dist="training"):
        ...
        elif params['PROBLEM'] in ("moving_point", "moving_point_vision","moving_point_dual"):
        elif params['PROBLEM'] in ("moving_point", "moving_point_vision","moving_point_realworld"):
